  ...
  <div id="of-popup-reset" class="of-save-popup">
   ...
   <div id="of-popup-fail" class="of-save-popup">
	...
	<div class="pmc-licence">
		...
		<h2>This is lite Version of Marketeer</h2>
		<p>With full version you get:</p>
		<ul class="freya-lite">
		<li>Revolution Slider Plugin</li>
		<li>Styling options (you can change colors, set boxed version of theme, etc.)</li>
		<li>Typography (you can change fonts)</li>		
		<li>Three version of the blog</li>		
		</ul>
		<a class="buy-freya button" title = "Click to check out the Premium Version" href ="https://premiumcoding.com/wordpress-themes/marketeer-digital-marketplace-wordpress-theme/" target = "_blank">Buy Marketer now and save 30% with discount code "marketer-lite"</a>
	</div>  	
...
public static function optionsframework_machine($options) {
  ...
  if(isset($_GET["import"]) && $_GET["import"] == 'start'){   
		...
		$theme_xml = PMC_PATH . 'import/marketeer.xml';
			...
			foreach($menus as $menu) { // assign menus to theme locations
				...
				switch($menu_items->name){
					case 'Main menu':
						...
						break;										
					case 'Top Menu':
						$locations['pmctopmenu'] = $menu->term_id;										
						break;									
				}				
			}
		}
...
public static function optionsframework_slider_function($id,$std,$oldorder,$order,$int, $social = false,  $menu = false, $sidebar = false){
	...
	if ($social){
		$slider .= '<label>Link URL</label>';} else {	
		if(!$menu && !$sidebar){
