...
//Testing 
$of_options_marketeer_select = array("one","two","three","four","five"); 
$of_options_marketeer_radio = array("one" => "One","two" => "Two","three" => "Three","four" => "Four","five" => "Five");
$of_options_marketeer_homepage_blocks = array( 
	"disabled" => array (
...
$of_options_marketeer_thumb_align = array("alignleft" => "Left","alignright" => "Right","aligncenter" => "Center"); 
// Image Links to Options
$of_options_marketeer_image_link_to = array("image" => "The Image","post" => "The Post"); 
...
$of_options_pmc[] = array( "name" => "Custom Sidebar settings",
                    "type" => "innerheading");
							
$of_options_pmc[] = array( "name" => "Sidebars",
					"desc" => "You can add unlimited number of sidebar and sort them with drag and drop. Sidebars can be then used in pagebuilder Widget block.",
					"id" => "sidebar",
					"std" =>  array('title' => 'Custom Sidebar'),				
					"social" => false,	
					"menu" => false,	
					"sidebar" => true,
					"type" => "slider");					
...
$of_options_pmc[] = array( "name" => "Check this is you wish to display deals on blog page! Only on grid blog layout!",
					"desc" => "Check this is you wish to show deals on blog pages. ",
					"id" => "blog_deals",
					"std" => 1,
					"type" => "checkbox");			
...
$of_options_pmc[] = array( "name" => "Deals",
                    "type" => "innerheading");						

$of_options_pmc[] = array( "name" => "Check all deals link",
					"desc" => "Add link to all deals page.",
					"id" => "delas_link",
...
$of_options_pmc[] = array( "name" => "Show sorting deals on home page",
					"desc" => "Check this if you wish to use sorting deals on home page.",
					"id" => "use_sort",
					"std" => 0,
					"type" => "checkbox");					
...
$of_options_pmc[] = array( "name" => "Image for the first post (Recommended size 640px x 400px)",
					...
					"id" => "block1_img1",
					"std" => "http://marketeer-lite.premiumcoding.com/wp-content/uploads/2015/09/marketeer-lite-featured-post-small-3.jpg",
					"type" => "upload");	
...
$of_options_pmc[] = array( "name" => "404 Error page Title",
                    ...
                    "id" => "errorpagetitle",
                    "std" => esc_html__('OOOPS! 404','marketeer-lite'),
                    "type" => "text");	
										
$of_options_pmc[] = array( "name" => "404 Error page Title Content Text",
                    "desc" => "Add a description for your 404 page.",
                    "id" => "errorpage",
                    "std" => esc_html__('Sorry, but the page you are looking for has not been found.<br/>Try checking the URL for errors, then hit refresh.</br>Or you can simply click the icon below and go home:)','marketeer-lite'),
                    "type" => "textarea");	   	
...
$of_options_pmc[] = array( "name" => "Copyright info",
                    ...
                    "id" => "copyright",
                    "std" => esc_html__('&copy; 2011 All rights reserved. ','marketeer-lite'),
                    "type" => "textarea");
